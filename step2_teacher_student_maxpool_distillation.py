...
checkpoint=torch.load('/home/why/Workspace-Python/DTFD-MIL.PyTorch/MaxPool_model_best.pth',map_location='cpu')
...
for ii in range(params.EPOCH):
    ...
    for i, data in enumerate(trainloader):
        ...
        if i>100 and i%5000==0:
            ...
            # if mae<best_mae:
            #     best_mae=mae
            torch.save(model_student.state_dict(), 'ResNet50_MaxPool_teacher_student_best1024.pth')

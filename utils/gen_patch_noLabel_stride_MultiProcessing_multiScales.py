...
slides_folder_dir = '/path/to/CAMELYON16/training/tumor/' # change the directory for different sub-folder
slide_paths = glob.glob(os.path.join(slides_folder_dir, '*.tif'))  # change the surfix '.tif' to other if necessary
save_folder_dir = '/path/to/CAMELYON16/extracted_patches/training/tumor/'
####======================================
